...
// Pay — проверяет право и сразу списывает его (через PurchaseRight.Buy), одной
// атомарной операцией на уровне БД (см. PurchaseRightRepository.MarkAsUsed),
// чтобы гонка "оплата vs истечение" (RGT-07) разрешалась предсказуемо.
